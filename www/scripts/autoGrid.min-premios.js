    ...
    f.fn.grid = function (j) {
        var h = function (w) {
            ...
            var D = function (au, aA, aq) {
                var az = "../../content/images/premios/";
                if (aq == "no") {
                    az = ""
                }
                var ar = au + "/content/images/premios/";
                if (au == "PREMIOS") {
                    ar = ""
                }
                var aw = aA.split(/\.(?=[^.]*$)/)[0];
                var av = "<h5>In " + au + "</h5>";
                if (au == "PREMIOS" || E.captionCategory == false) {
                    av = ""
                }
                var at = "";
                if (aw.indexOf("$$") != -1) {
            ...
            f.getJSON(window.location.origin+"/reader-premios.php?directory=" + am + "&categoriesOrder=" + E.categoriesOrder + "&imagesOrder=" + E.imagesOrder, function (aq) {
                M = aq;
                C.css("display", "none");
                v();
