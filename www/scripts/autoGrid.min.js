    ...
    f.fn.grid = function (j) {
        var h = function (w) {
            ...
            var D = function (au, aA, aq) {
                ...
                var ax = '<div class="box" data-category="' + au + '" ' + at + '><img src="' + am + "/" + ar + az + aA + '" data-lightbox="' + am + "/" + ar + aA + '" /><div class="image-caption"><h3>' + aq.thumb + "</h3>" + av + '</div><div class="lightbox-text">' + aw + " <span>In " + au + "</span></div></div>";
                return ax
            };
            var l = function () {
                var aq = ai();
            ...
            f.getJSON(window.location.origin+"/reader.php?directory=" + am + "&categoriesOrder=" + E.categoriesOrder + "&imagesOrder=" + E.imagesOrder, function (aq) {
                M = aq;
                C.css("display", "none");
                v();
